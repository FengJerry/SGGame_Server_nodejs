...
exports.Response = function (req , res) {
	...
	var insertUpgradeHero = 'insert into tb_heroupgrade (UserId,HeroId,HeroLevel,StartTime,EndTime,IsOver) value (' + connection.escape(req.body.userId)
	                                                                                                                + ','
                                                                                                                    + connection.escape(req.body.heroId)
                                                                                                                    + ','
